import type { Project, Skill, Service, Experience, Stat, Testimonial, Language, ProfileData } from "./index";

export const PROFILE_STATIC: ProfileData = {
...
export const PROJECTS_EN: Project[] = [
  ...
  {
    id: "university-scheduler", number: "03",
  ...
  },
  {
    ...
    solution: "Built a comprehensive multi-purpose business platform with integrated e-commerce, real-time inventory management, order workflow automation, and built-in customer messaging. Features a modern storefront with dynamic product catalogs, streamlined checkout, and an admin dashboard for end-to-end business operations.",
    complexity: "High",
    technologies: ["React", "Node.js", "PostgreSQL", "Stripe", "Redis", "Docker", "WebSocket"],
    highlights: [
      "Full e-commerce storefront with dynamic product catalogs and search",
      "Real-time inventory tracking with automated low-stock alerts",
      "Order management workflow from placement to fulfillment",
      "Built-in customer communication and notification system",
...
export const PROJECTS_AR: Project[] = [
  ...
  },
  {
    ...
    solution: "بناء منصة أعمال شاملة متعددة الأغراض مع متجر إلكتروني متكامل، وإدارة مخزون في الوقت الفعلي، وأتمتة سير عمل الطلبات، ونظام رسائل مدمج مع العملاء. تتميز بواجهة متجر حديثة مع كتالوجات منتجات ديناميكية، وعملية دفع مبسطة، ولوحة تحكم إدارية لإدارة العمليات من البداية إلى النهاية.",
    complexity: "High",
    technologies: ["React", "Node.js", "PostgreSQL", "Stripe", "Redis", "Docker", "WebSocket"],
    highlights: [
      "متجر إلكتروني متكامل مع كتالوجات منتجات ديناميكية وبحث متقدم",
      "تتبع المخزون في الوقت الفعلي مع تنبيهات آليّة لنفاد المخزون",
      "سير عمل لإدارة الطلبات من التقديم إلى التنفيذ",
      "نظام تواصل مدمج مع العملاء وإشعارات ذكية",
      "لوحة تحكم إدارية مع تحليلات المبيعات والتقارير",
...
export const SKILLS_EN: Skill[] = [
  {
    category: "Engineering Systems", icon: "cpu",
  ...
  {
    category: "AI & Data Processing", icon: "brain",
  ...
  {
    category: "Mobile Development", icon: "smartphone",
...
export const SERVICES_EN: Service[] = [
  {
    ...
    pricing: "from $5,000",
    features: [
      "Custom web & mobile applications", "API design & development",
      "Database architecture", "Cloud deployment & DevOps",
      "Performance optimization", "Ongoing maintenance & support"
    ],
  },
  {
    id: "ai-integration", icon: "sparkles",
    ...
    pricing: "from $3,000",
    features: [
      "AI API integration (OpenAI, Claude, etc.)", "Custom ML model development",
      "Intelligent automation workflows", "Data preprocessing & cleaning",
      "Prompt engineering & optimization", "AI-powered analytics"
    ],
  },
  {
    id: "system-architecture", icon: "network",
    ...
    pricing: "from $2,000",
    features: [
      "System architecture design", "Technical feasibility analysis",
      "Performance optimization", "Scalability planning",
      "Security audit & hardening", "Technology stack recommendations"
    ],
  },
];
...
export const SERVICES_AR: Service[] = [
  {
    ...
    features: [
      "تطبيقات ويب وموبايل مخصصة", "تصميم وتطوير الـ APIs",
      "هندسة قواعد البيانات", "النشر السحابي والـ DevOps",
      "تحسين الأداء", "الصيانة والدعم المستمر"
    ]
  },
  {
    id: "ai-integration", icon: "sparkles",
    ...
    features: [
      "دمج واجهات الذكاء الاصطناعي (OpenAI, Claude, إلخ)", "تطوير نماذج تعلم آلة مخصصة",
      "مسارات عمل للأتمتة الذكية", "معالجة وتنظيف البيانات",
      "هندسة وتحسين الأوامر (Prompts)", "تحليلات مدعومة بالذكاء الاصطناعي"
    ]
  },
  {
    id: "system-architecture", icon: "network",
    ...
    features: [
      "تصميم معمارية الأنظمة", "تحليل الجدوى التقنية",
      "تحسين الأداء التقني", "تخطيط التوسع المستقبلي",
      "تدقيق الأمان وتقوية الأنظمة", "توصيات بمجموعة التقنيات المناسبة"
    ]
  }
];
...
export const EXPERIENCE_EN: Experience[] = [
  {
    id: "exp-1", year: "2022 - Present",
    title: "Senior Full-Stack Engineer", company: "Freelance / Contract",
  ...
  {
    id: "exp-2", year: "2020 - 2022",
    title: "Full-Stack Developer", company: "Tech Startup",
...
export const EXPERIENCE_AR: Experience[] = [
  {
    id: "exp-1", year: "2022 - الآن",
    title: "مهندس برمجيات أول (Full-Stack)", company: "عمل حر / تعاقد",
  ...
  {
    id: "exp-2", year: "2020 - 2022",
    title: "مطور Full-Stack", company: "شركة تقنية ناشئة",
...
export const TESTIMONIALS_EN: Testimonial[] = [
  {
    id: "test-1", name: "Sarah Johnson", role: "CEO", company: "RetailTech Solutions",
  ...
  {
    id: "test-2", name: "Dr. Michael Chen", role: "Academic Director", company: "University of Technology",
  ...
  {
    id: "test-3", name: "Ahmed Al-Rashid", role: "Founder", company: "Digital Commerce Hub",
...
export const TESTIMONIALS_AR: Testimonial[] = [
  {
    id: "test-1", name: "سارة جونسون", role: "المدير التنفيذي", company: "RetailTech Solutions",
  ...
  {
    id: "test-2", name: "د. مايكل تشن", role: "المدير الأكاديمي", company: "جامعة التكنولوجيا",
  ...
  {
    id: "test-3", name: "أحمد الراشد", role: "المؤسس", company: "Digital Commerce Hub",
...
export const translations: Record<Language, any> = {
  en: {
    ...
    hero: {
      ...
      cta1: "Start a Project", cta2: "View My Work", techStack: "Tech Stack",
    },
    about: {
      title: "About", subtitle: "Building intelligent systems that solve real problems",
    ...
    expertise: { title: "Expertise", subtitle: "Core capabilities across the full development stack" },
    projects: {
      title: "Projects", subtitle: "Case studies of complex systems and intelligent solutions",
      problem: "Problem", solution: "Solution", complexity: "Complexity",
      technologies: "Technologies", highlights: "Key Highlights", viewDetails: "View Details",
    },
    services: { title: "Services", subtitle: "How I can help bring your vision to life", features: "What's Included" },
    experience: { title: "Experience", subtitle: "Professional journey and key achievements", achievements: "Key Achievements" },
    testimonials: { title: "Testimonials", subtitle: "What clients say about working together" },
    contact: {
      title: "Let's Work Together", subtitle: "Have a project in mind? Let's discuss how I can help.",
      info: "Contact Information", email: "Email", location: "Location",
      availability: "Availability", availableText: "Available for freelance projects", social: "Connect",
      form: {
        name: "Your Name", email: "Your Email", projectType: "Project Type",
        message: "Tell me about your project", submit: "Send Message", sending: "Sending...",
        projectTypes: { web: "Web Application", mobile: "Mobile App", ai: "AI Integration", consulting: "Consulting", other: "Other" },
      },
    },
    footer: { copyright: "© 2026 All rights reserved.", builtWith: "Built with precision and passion" },
    dashboard: {
      title: "Dashboard", overview: "Overview",
      messages: "Messages", projects: "Projects",
      skills: "Skills", services: "Services",
      experience: "Experience", stats: "Statistics",
      testimonials: "Testimonials", profile: "Profile",
      all: "All", unread: "Unread", read: "Read",
      markRead: "Mark as read", markUnread: "Mark as unread",
      delete: "Delete", add: "Add", edit: "Edit", save: "Save",
      cancel: "Cancel", confirmDelete: "Are you sure?",
      confirmDeleteDesc: "This action cannot be undone.",
      noData: "No data yet.", addFirst: "Add your first item",
      search: "Search...", signOut: "Sign Out",
      loading: "Loading...", saved: "Saved successfully",
  ...
  ar: {
    ...
    hero: {
      ...
      cta1: "ابدأ مشروعاً", cta2: "شاهد أعمالي", techStack: "التقنيات",
    },
    about: {
      title: "نبذة", subtitle: "بناء أنظمة ذكية تحل مشاكل حقيقية",
    ...
    expertise: { title: "الخبرات", subtitle: "القدرات الأساسية عبر مجموعة التطوير الكاملة" },
    projects: {
      title: "المشاريع", subtitle: "دراسات حالة لأنظمة معقدة وحلول ذكية",
      problem: "المشكلة", solution: "الحل", complexity: "التعقيد",
      technologies: "التقنيات", highlights: "النقاط الرئيسية", viewDetails: "عرض التفاصيل",
    },
    services: { title: "الخدمات", subtitle: "كيف يمكنني المساعدة في تحويل رؤيتك إلى واقع", features: "ما المتضمن" },
    experience: { title: "التجربة", subtitle: "الرحلة المهنية والإنجازات الرئيسية", achievements: "الإنجازات الرئيسية" },
    testimonials: { title: "الآراء", subtitle: "ما يقوله العملاء عن العمل معاً" },
    contact: {
      title: "لنعمل معاً", subtitle: "لديك مشروع في ذهنك؟ دعنا نناقش كيف يمكنني المساعدة.",
      info: "معلومات الاتصال", email: "البريد الإلكتروني", location: "الموقع",
      availability: "التوفر", availableText: "متاح لمشاريع العمل الحر", social: "تواصل",
      form: {
        name: "اسمك", email: "بريدك الإلكتروني", projectType: "نوع المشروع",
        message: "أخبرني عن مشروعك", submit: "إرسال الرسالة", sending: "جاري الإرسال...",
        projectTypes: { web: "تطبيق ويب", mobile: "تطبيق موبايل", ai: "دمج ذكاء اصطناعي", consulting: "استشارات", other: "أخرى" },
      },
    },
    footer: { copyright: "© 2026 جميع الحقوق محفوظة.", builtWith: "بُني بدقة وشغف" },
    dashboard: {
      title: "لوحة التحكم", overview: "نظرة عامة",
      messages: "الرسائل", projects: "المشاريع",
      skills: "المهارات", services: "الخدمات",
      experience: "الخبرات", stats: "الإحصائيات",
      testimonials: "الآراء", profile: "الملف الشخصي",
      all: "الكل", unread: "غير مقروء", read: "مقروء",
      markRead: "تحديد كمقروء", markUnread: "تحديد كغير مقروء",
      delete: "حذف", add: "إضافة", edit: "تعديل", save: "حفظ",
      cancel: "إلغاء", confirmDelete: "هل أنت متأكد؟",
      confirmDeleteDesc: "لا يمكن التراجع عن هذا الإجراء.",
      noData: "لا توجد بيانات بعد.", addFirst: "أضف أول عنصر",
      search: "بحث...", signOut: "تسجيل الخروج",
      loading: "جاري التحميل...", saved: "تم الحفظ بنجاح",
      saveFailed: "فشل الحفظ", deleteFailed: "فشل الحذف",
