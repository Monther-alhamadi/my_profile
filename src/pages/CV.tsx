        ...
        <RevealWrapper>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-12 md:mb-16">
            {stats.map((stat) => (
              <div
                key={stat.id}
                className="border border-ivory/10 rounded-sm p-5 text-center"
              >
              ...
              <div key={exp.id} className="ruled-card-dark p-6 md:p-8">
                <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8">
                  <div className="flex-shrink-0 md:w-28">
                    <span className="font-mono text-sm font-semibold text-emerald-brand">
                      {exp.year}
                    </span>
                  </div>
                  <div className="flex-1">
                    <div className="flex flex-wrap items-baseline gap-2 mb-2">
                      ...
                      <span className="text-sm text-ivory/38 font-mono">
                        @ {exp.company}
                      </span>
                    </div>
                    <p className="text-sm text-ivory/52 leading-relaxed mb-4">
                      {exp.description}
                    </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {skills.map((skill) => (
              <div key={skill.category} className="ruled-card-dark p-6">
                <h3 className="text-sm font-bold text-ivory mb-3">
                  {skill.category}
                </h3>
